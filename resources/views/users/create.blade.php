...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header py-3">{{ __('Create New User') }}</div>

                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('users.confirm-create') }}"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="row mb-3">
                                <label for="name"
                                    class="col-md-4 col-form-label required text-md-end">{{ __('Name') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="email"
                                    class="col-md-4 col-form-label required text-md-end">{{ __('Email Address') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="password"
                                    class="col-md-4 col-form-label required text-md-end">{{ __('Password') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="password_confirmation"
                                    class="col-md-4 col-form-label required text-md-end">{{ __('Confirm Password') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="dob" type="date"
                                        ...
                                        autocomplete="dob" value="{{ old('dob') }}" />
                            ...
                            <div class="row mb-3">
                                <label for="profile"
                                    class="col-md-4 col-form-label required text-md-end">{{ __('Profile') }}</label>

                                <div class="col-md-6">
                                    <input id="profile" type="file"
                                        class="form-control @error('profile') is-invalid @enderror" name="profile"
                                        required autocomplete="profile" value="{{ old('profile') }}" />
