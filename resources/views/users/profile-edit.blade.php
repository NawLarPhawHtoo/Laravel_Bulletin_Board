...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header py-3">{{ __('Profile Edit') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('profile.edit') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="number"
                                        ...
                                        autocomplete="phone" value="{{ $user->phone }}" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    @if ($user->profile)
                                    <img class="profile-image" src="{{ asset('storage/profiles/' . $user->profile) }}">
                                    @else
