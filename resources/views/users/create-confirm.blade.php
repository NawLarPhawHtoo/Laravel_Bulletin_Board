...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header py-3">{{ __('Create User Confirm') }}</div>
                        ...
                        <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        ...
                                        value="{{ old('password') }}" required autocomplete="password" autofocus readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password_confirmation" type="password"
                                        ...
                                        autocomplete="password_confirmation" autofocus readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img style="max-width:50%;" src="{{ asset('profiles/' . Session::get('profile')) }}"
                                        alt="Profile Image" />
                                </div>
                            </div>
